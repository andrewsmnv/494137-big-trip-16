import { TRIP_POINTS_ARRAY, CITIES_ARRAY, OFFERS_ARRAY, createOffersArray } from '../createMockData';

export const addCardTemplate = (event) => {
                ...
                <section class="event__details">
                  <section class="event__section  event__section--offers">
                    ...
                    <div class="event__available-offers">
                      ${generateOffersList(OFFERS_ARRAY)}
                    </div>
                  </section>
                  ...
                  <section class="event__section  event__section--destination">
                    ...
                    <div class="event__photos-container">
                      ...
                      ${generatePhotosList(event.destination.photos)}
                      </div>
                    </div>
                  </section>
                </section>
